...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return qnn.QuantConv2d(in_planes, out_planes, kernel_size = (3,3), bias=False, weight_quant = None, stride = (stride,stride), padding = (1,1))
    #return qnn.QuantConv2d(in_planes, out_planes, kernel_size = 3, bias=False, weight_bit_width=4)

def conv1x1(in_planes, out_planes, stride=1):
    """1x1 convolution"""
    #return nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False)
    return qnn.QuantConv2d(in_planes, out_planes, kernel_size = (1,1), bias=False, weight_quant=None, stride = (stride,stride))
    #return qnn.QuantConv1d(in_planes, out_planes, kernel_size = 1, bias=False, weight_bit_width=4)
...
class CifarResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10):
        ...
        self.fc = qnn.QuantLinear(64 * block.expansion, num_classes, bias=True, weight_quant=None)
